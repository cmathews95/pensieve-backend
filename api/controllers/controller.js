...
function fetchInstaLocations(latitude = "34.411640", longitude = "-119.847060") {
    var api = `https://api.instagram.com/v1/locations/search?lat=${latitude}&lng=${longitude}&access_token=${TOKEN}`;
    console.log(api);
    return new Promise((resolve, reject) => {
...
exports.instaImages = function(req, res) {
    var lat = null;
    var lon = null;
...
exports.instagramHandleScraper = function(req, res) {
    var handle = null;
    var n = null;
...
exports.instagramProfileScraper = function(req, res) {
    var profile = null;
    var n = null;
